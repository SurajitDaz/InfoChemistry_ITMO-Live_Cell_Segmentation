...
a = 50, #int(sv1) - int(sv2 * remaining_min(sv1))
countcount = 0
def fl_math(intensity_value,mean, median, modd):
    global countcount, a
    global sv1, sv2
...
def extract_and_classify_image_gray(img_colr,image, output_file, neighborhood_size):
    """
    Extract spatial statistics (Moran's I, Geary's C, Variogram, Standard Deviation)
    ...
    for x, y in zip(x_coords, y_coords):
            if new_img[y,x]>a:
                ...
                fl_pix_val = fl_math(intensity_value, mean, median, modd)
...
def main():
    ...
    image_path="C:/Users/Jit/AppData/Local/Programs/Python/Python312/z_My_Work/CV/All_IMGs/33.jpg"
    #image_path="/home/surajit/CV/Unsupervised_Learning_NEW/3411.jpg"
    ...
    if image_original is None:
        ...
        extract_and_classify_image_gray(image_original,image, output_file, neighborhood_size)
