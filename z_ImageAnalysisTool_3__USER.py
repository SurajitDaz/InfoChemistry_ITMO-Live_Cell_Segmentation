...
slider4_var = tk.DoubleVar(value=0.5)  # Default value for slider 4
slider5_var = tk.DoubleVar(value=0.5)  # Default value for slider 5
...
def open_slider_window(option):
    ...
    if option == "HIP Perceived Grayscale Analysis":
        slider1 = tk.Scale(slider_window, from_=0, to=255, resolution=0.01, orient=tk.HORIZONTAL, label="Span Gray", variable=slider1_var)
        ...
        slider4 = tk.Scale(slider_window, from_=0, to=1, resolution=0.01, orient=tk.HORIZONTAL, label="Correlation Threshold", variable=slider4_var)
        slider4.pack(fill=tk.X, padx=5, pady=5)
        
        slider5 = tk.Scale(slider_window, from_=0, to=1, resolution=0.01, orient=tk.HORIZONTAL, label="Dependency Threshold", variable=slider5_var)
...
def reset_sliders(slider_window, option):
    ...
    if option == "HIP Perceived Grayscale Analysis":
        ...
        slider4_var.set(0.5)  # Default value for slider 4
        slider5_var.set(0.5)  # Default value for slider 5
...
neighborhood_entry = tk.Entry(dropdown_frame, textvariable=tk.StringVar(value="5"),width=2)
